...
\def\xxfigures{
\includegraphics[width=0.4\textwidth]{turbine_alstom.jpeg}\\
\textit{Turbine à gaz Alstom}

\includegraphics[width=0.5\textwidth]{turboreacteur.jpeg}\\
...
\begin{center}
\includegraphics[width=0.9\textwidth]{req_pompe.pdf}\\
...
\begin{center}
\begin{tabular}{cc}
\includegraphics[width=0.3\textwidth]{rotor_pompe.jpg}
&
\includegraphics[width=0.5\textwidth]{guidage_pompe.jpg}
\\
Rotor de la pompe
&
...
%\begin{figure}[htbf!]
\begin{center}
\includegraphics[width=.8\linewidth]{figure_presentation.pdf}
%%%\scFigCalc[z_{0,3}]{x_0}{y_0}{x_3}{y_3}{\theta}
\includegraphics[width=.4\linewidth]{sc}
\end{center}
...
\begin{center}
\includegraphics[width=1.0\textwidth]{effort.pdf}
\end{center}
\end{minipage}
\begin{minipage}{0.45\textwidth}
\begin{center}
\includegraphics[width=1.0\textwidth]{moment.pdf}
\end{center}
\end{minipage}
\end{center}
...
%\begin{figure}[ht!]
  \begin{center}
  \includegraphics[width=0.8\textwidth]{illustration_equilibrage.png}
...
\begin{figure}[ht!]
\begin{center}
\includegraphics[width=0.9\textwidth]{figure-masse-roue.pdf}
\end{center}
...
\begin{center}
\includegraphics[width=.9\linewidth]{machine_equilibrage.jpeg}
\end{center}
\end{minipage}
\end{prop}
